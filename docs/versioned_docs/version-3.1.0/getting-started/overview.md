...
- **Two-Phase In-Memory Tail Reading:** Zero-copy scattered sequence gathering across distributed keepers, bounding network payload transfer to exactly $N$ events.
