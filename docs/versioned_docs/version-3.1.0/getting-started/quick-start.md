...
Download the pre-built binary tarball for v3.1.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases) page:
...
From inside the extracted directory (`chronolog-3.1.0`), run the deployment script:
...
Download the RPM package for v3.1.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases/tag/v3.1.0) page:

```bash
wget https://github.com/grc-iit/ChronoLog/releases/download/v3.1.0/chronolog-3.1.0-linux-x86_64.rpm
```
...
sudo yum install ./chronolog-3.1.0-linux-x86_64.rpm
```
...
Download the DEB package for v3.1.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases/tag/v3.1.0) page:

```bash
wget https://github.com/grc-iit/ChronoLog/releases/download/v3.1.0/chronolog-3.1.0-linux-x86_64.deb
```
...
```bash
docker pull ghcr.io/grc-iit/chronolog:v3.1.0
```

## Run the Container

```bash
docker run -it --rm ghcr.io/grc-iit/chronolog:v3.1.0 bash
```
