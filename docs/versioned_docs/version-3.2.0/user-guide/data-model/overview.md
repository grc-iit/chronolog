...
- **[Event](./concepts.md#event)** — The atomic data unit, carrying a timestamp, client ID, event index, and an opaque payload. Globally ordered by `EventSequence = (eventTime, clientId, eventIndex)`.
