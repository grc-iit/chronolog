...
| `/query` | POST | Query archived events over a time range (Replay mode) |
| `/playback` | POST | Tail-read the most recent $N$ events directly from keeper memory (Playback mode) |
