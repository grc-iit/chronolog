...
Download the pre-built binary tarball for v3.0.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases) page:

```bash
wget https://github.com/grc-iit/ChronoLog/releases/download/v3.0.0/chronolog-3.0.0-linux-x86_64.tar.gz
```
...
```bash
tar -xzf chronolog-3.0.0-linux-x86_64.tar.gz
```
...
From inside the extracted directory (`chronolog-3.0.0`), run the deployment script:
...
Download the RPM package for v3.0.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases/tag/v3.0.0) page:

```bash
wget https://github.com/grc-iit/ChronoLog/releases/download/v3.0.0/chronolog-3.0.0-linux-x86_64.rpm
```
...
sudo dnf install ./chronolog-3.0.0-linux-x86_64.rpm

# Or with yum (RHEL 7, CentOS)
sudo yum install ./chronolog-3.0.0-linux-x86_64.rpm
```
...
Download the DEB package for v3.0.0 from the [ChronoLog GitHub Releases](https://github.com/grc-iit/ChronoLog/releases/tag/v3.0.0) page:

```bash
wget https://github.com/grc-iit/ChronoLog/releases/download/v3.0.0/chronolog-3.0.0-linux-x86_64.deb
```
...
```bash
sudo apt install ./chronolog-3.0.0-linux-x86_64.deb
```
...
```bash
docker pull ghcr.io/grc-iit/chronolog:v3.0.0
```

## Run the Container

```bash
docker run -it --rm ghcr.io/grc-iit/chronolog:v3.0.0 bash
```
