...
This downloads the ChronoLog v2.8.0 image to your local machine, with a pre-installed release build ready to use.
...
```bash
docker run -it --rm --name chronolog-instance ghcr.io/grc-iit/chronolog:v2.8.0
```
...
bfbc93af1d50   ghcr.io/grc-iit/chronolog:v2.8.0        "/bin/bash"   X seconds ago    Up X seconds             chronolog-instance
```
