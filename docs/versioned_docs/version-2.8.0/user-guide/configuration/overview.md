...
Starting with ChronoLog v2.8.0 the configuration system is split into a lightweight loader and a set of per-component configuration classes. This replaces the earlier monolithic `ConfigurationManager` that owned the parsed state of every component.
