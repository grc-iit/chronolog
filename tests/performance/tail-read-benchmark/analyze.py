...
def main():
    ...
    made = [
        ...
        fig_sweep(agg, "B2", "wr_p50", "wr_p99", "playback_n (tail depth)",
                  "log_event() service time (us, log)",
                  "Write-path interference: deep tail reads stall ingestion",
                  os.path.join(args.results_dir, "fig_B2_write.png")),
