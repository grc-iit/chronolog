...
#
# The regression case is frozen per tests/performance/perf_regression_design.md:
#
...
ARES_TEST="${SCRIPT_DIR}/ares_test.sh"
EXTRACT_PY="${SCRIPT_DIR}/extract_plot_results.py"
