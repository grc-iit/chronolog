...
- current open work: full requested final grid is incomplete; ChronoLog 2-node archive/range timed out waiting for archive event count; PMDK rows need actual reruns with explicit walltime and 3 GiB storage targets; remaining 2/4/5/16-node and 4K/16K/64K requested-grid cells still need staged execution
