...
def build_evidence(iteration: int) -> dict[str, Any]:
    ...
    evidence = {
        ...
        "benchmark": {
            ...
            "operation_count_per_client": raw_metrics.get("operation_count_per_client"),
            "message_count_per_client": raw_metrics.get("message_count_per_client"),
            "total_operation_count": raw_metrics.get("total_operation_count"),
            "total_message_count": raw_metrics.get("total_message_count"),
            "total_payload_bytes": raw_metrics.get("total_payload_bytes"),
            "parallel_client_count": raw_metrics.get("parallel_client_count"),
